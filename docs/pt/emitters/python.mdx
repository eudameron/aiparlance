...
description: "@aiparlance/python — papel app, nota 12/55, objetivos pass/partial/fail"
---
...
Scorecard completo (incluindo ➖ N/A): [transpilers/python/EMITTER_OBJECTIVES.md](https://github.com/eudameron/aiparlance/blob/main/transpilers/python/EMITTER_OBJECTIVES.md).
