...
| **Nota** | **14/23** (61%) |
| Nível | Fatia sólida |
| Ficha de maturidade | [transpilers/mysql/EMITTER_OBJECTIVES.md](https://github.com/eudameron/aiparlance/blob/main/transpilers/mysql/EMITTER_OBJECTIVES.md) |
...
Ficha de maturidade completa (incluindo ➖ N/A): [transpilers/mysql/EMITTER_OBJECTIVES.md](https://github.com/eudameron/aiparlance/blob/main/transpilers/mysql/EMITTER_OBJECTIVES.md).
