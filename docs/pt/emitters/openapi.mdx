...
description: "@aiparlance/openapi — papel contract, nota 20/33, objetivos pass/partial/fail"
---
...
OpenAPI 3.0.3 JSON: schemas, paths CRUD, `api.prefix`, schemes de auth, `security` por operação a partir de `policy` (+ `x-aip-policy`, 401/403 nas ops protegidas).
