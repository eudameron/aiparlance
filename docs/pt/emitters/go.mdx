...
| Ficha de maturidade | [transpilers/go/EMITTER_OBJECTIVES.md](https://github.com/eudameron/aiparlance/blob/main/transpilers/go/EMITTER_OBJECTIVES.md) |
...
Ficha de maturidade completa (incluindo ➖ N/A): [transpilers/go/EMITTER_OBJECTIVES.md](https://github.com/eudameron/aiparlance/blob/main/transpilers/go/EMITTER_OBJECTIVES.md).
