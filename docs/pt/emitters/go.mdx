---
title: Emitter Go
description: "@aiparlance/go — papel app, nota 12/55, objetivos pass/partial/fail"
---
...
Scorecard completo (incluindo ➖ N/A): [transpilers/go/EMITTER_OBJECTIVES.md](https://github.com/eudameron/aiparlance/blob/main/transpilers/go/EMITTER_OBJECTIVES.md).
