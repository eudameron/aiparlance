...
description: "@aiparlance/sql — papel schema, nota 17/23, objetivos pass/partial/fail"
---
...
DDL PostgreSQL: `CREATE TABLE`, índices, seeds e migrations de init versionadas (`0001_init.up/down` via `aip emit sql --migrations`). SQL principal.
