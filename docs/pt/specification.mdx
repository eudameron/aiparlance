...
**Toolchain (v0.1):** **parser**, **validador**, **emitter PostgreSQL (DDL)** e **OpenAPI 3** Core estão no monorepo (`aip parse` / `aip validate` / `aip emit sql|openapi`). **TypeScript / demais emitters** ainda não publicados. Este documento é a fonte normativa em prosa; gramática em [spec/v0.1/grammar.ebnf](https://github.com/eudameron/aiparlance/blob/main/spec/v0.1/grammar.ebnf) e marcos em [ROADMAP.md](https://github.com/eudameron/aiparlance/blob/main/ROADMAP.md).
