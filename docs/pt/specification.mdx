...
Blocos beta podem mudar entre releases v0.x menores. O Core é estável dentro do v0.1; a linguagem permanece **rascunho** (toolchain em Prévia no monorepo — ainda não é v1.0 congelada). Ver [ROADMAP](https://github.com/eudameron/aiparlance/blob/main/ROADMAP.md).
