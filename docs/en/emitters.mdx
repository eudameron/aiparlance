...
|---|---|---|---|
| PostgreSQL | `schema` | **19/23** (83%) | [sql](/en/emitters/sql) |
| MySQL | `schema` | **14/23** (61%) | [mysql](/en/emitters/mysql) |
| OpenAPI | `contract` | **28/33** (85%) | [openapi](/en/emitters/openapi) |
| TypeScript | `app` | **36/55** (65%) | [typescript](/en/emitters/typescript) |
