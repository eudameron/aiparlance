---
title: Go emitter
description: "@aiparlance/go — role app, score 12/55, pass/partial/fail objectives"
---
...
Full ID-by-ID scorecard (including ➖ N/A): [transpilers/go/EMITTER_OBJECTIVES.md](https://github.com/eudameron/aiparlance/blob/main/transpilers/go/EMITTER_OBJECTIVES.md).
