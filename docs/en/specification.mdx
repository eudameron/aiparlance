...
**Toolchain (v0.1):** Core **parser** and **validator** are in the monorepo (`packages/` — `aip parse` / `aip validate`). **Transpilers/emitters** are not published yet (matrix below remains Planned). This document is the normative prose source; see [spec/v0.1/grammar.ebnf](https://github.com/eudameron/aiparlance/blob/main/spec/v0.1/grammar.ebnf) for machine-oriented grammar and [ROADMAP.md](https://github.com/eudameron/aiparlance/blob/main/ROADMAP.md) for Phase C milestones.
