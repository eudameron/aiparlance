...
**Toolchain (v0.1):** Core **parser**, **validator**, **PostgreSQL DDL**, **OpenAPI 3**, and **TypeScript** emitters are in the monorepo (`aip parse` / `aip validate` / `aip emit sql|openapi|typescript`). Other matrix emitters are not published yet. This document is the normative prose source; see [spec/v0.1/grammar.ebnf](https://github.com/eudameron/aiparlance/blob/main/spec/v0.1/grammar.ebnf) and [ROADMAP.md](https://github.com/eudameron/aiparlance/blob/main/ROADMAP.md).
