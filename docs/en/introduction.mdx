...
| Page | Content |
|---|---|
| [Get started here](/en/getting-started) | Install, CLI, emit, and test |
...
| [Emitters](/en/emitters) | Maturity scores & objectives per emitter |
...
Next step for newcomers: [Get started here](/en/getting-started) or the [CRUD walkthrough](/en/crud-walkthrough).
