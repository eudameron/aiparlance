...
<Note>
**v0.1 is still a draft language.** A Core **parser** and **semantic validator** ship in the monorepo (`aip parse` / `aip validate` — see [ROADMAP](https://github.com/eudameron/aiparlance/blob/main/ROADMAP.md)). Official **emitters** (SQL, OpenAPI, TypeScript, …) are not published yet. This documentation remains the normative source for the language.
</Note>
