...
Matrix status: [Specification § Transpiler matrix](/en/specification#transpiler-matrix). Roadmap: [Phase D](https://github.com/eudameron/aiparlance/blob/main/ROADMAP.md).
